...
from webapp.view.base import products_view, product_view, product_add_view, products_delete, product_edit
...
urlpatterns = [
    ...
    path('products/<int:pk>/delete', products_delete, name='product_delete'),
